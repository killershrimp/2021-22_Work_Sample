...
//
//public class TestTurnInPlaceAutoMode extends AutoModeBase {
//    @Override
//    protected void routine() throws AutoModeEndedException {
//        runAction(new DriveTrajectoryAction(TrajectoryGenerator.getInstance().getTrajectorySet().turnInPlace));
//    }
//}