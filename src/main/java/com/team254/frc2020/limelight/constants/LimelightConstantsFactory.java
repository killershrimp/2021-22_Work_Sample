...
public class LimelightConstantsFactory {
    public static LimelightConstants getConstantsForId(int id) {
        double kTurretLimelightLensOffGroundHeight = 26.48;
        Rotation2d kTurretLimelightHorizontalPlaneToLens = Rotation2d.fromDegrees(27.00);
        ...
        switch (id) {
            ...
            case 1:
                ...
                return new LimelightConstants(
                        ...
                        kTurretLimelightLensOffGroundHeight, // height
                        new Pose2d(-5.7, 0, Rotation2d.fromDegrees(1.0)), // turret to lens
                        kTurretLimelightHorizontalPlaneToLens, // horizontalPlaneToLens,
            ...
            case 3:
                ...
                return new LimelightConstants(
                        3, // label id
                        LimelightConstants.Type.StationAlignment,
                        "Intake Limelight #3", // name
                        "limelight", // table name
                        kTurretLimelightLensOffGroundHeight, // height TODO set to intake LL constants
                        new Pose2d(-5.7, 0, Rotation2d.fromDegrees(1.5)), // turret to lens TODO set to intake LL constants
                        kTurretLimelightHorizontalPlaneToLens, // horizontalPlaneToLens TODO set to intake LL constants
